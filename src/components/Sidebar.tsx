...
export function Sidebar() {
  ...
  const sidebarContent = (
    <>
      <div className="flex h-14 items-center gap-2.5 border-b border-gray-100 dark:border-gray-800/80 px-4 flex-shrink-0">
        <div className="flex h-7 w-7 items-center justify-center rounded-lg bg-brand-500 text-white text-xs font-bold shadow shadow-brand-900/30">
          <svg className="h-3.5 w-3.5" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={2.5}>
            <path strokeLinecap="round" strokeLinejoin="round" d="M9.813 15.904 9 18.75l-.813-2.846a4.5 4.5 0 0 0-3.09-3.09L2.25 12l2.846-.813a4.5 4.5 0 0 0 3.09-3.09L9 5.25l.813 2.846a4.5 4.5 0 0 0 3.09 3.09L15.75 12l-2.846.813a4.5 4.5 0 0 0-3.09 3.09Z" />
          </svg>
        </div>
        <span className="text-sm font-bold tracking-tight text-gray-900 dark:text-gray-100">Job Tailor</span>
          ...
          return (
            <Link
              ...
              className={`flex items-center gap-3 rounded-lg px-3 py-2 text-sm font-medium transition-all duration-150 ${
                isActive
                  ? "bg-brand-50 text-brand-700 shadow-sm dark:bg-brand-950/80 dark:text-brand-300 dark:shadow-none"
                  : "text-gray-600 hover:bg-gray-50 hover:text-gray-900 dark:text-gray-400 dark:hover:bg-gray-800/60 dark:hover:text-gray-100"
              }`}
            >
              <item.icon className={`h-4 w-4 flex-shrink-0 ${isActive ? "text-brand-600 dark:text-brand-400" : ""}`} />
              <span className="truncate">{item.label}</span>
              {isActive && (
                <span className="ml-auto h-1.5 w-1.5 rounded-full bg-brand-500 flex-shrink-0" />
              )}
            </Link>
          );
        })}
      ...
      <div className="border-t border-gray-100 dark:border-gray-800/80 flex-shrink-0">
        <SourceHealthIndicator />
        <div className="p-3">
          {sessionLoading ? null : isPro ? (
            <div className="flex items-center gap-2 px-3 py-2 rounded-lg text-xs font-semibold text-emerald-700 bg-emerald-50 border border-emerald-100 dark:bg-emerald-950/40 dark:border-emerald-900/50 dark:text-emerald-400 mb-1">
            ...
            <Link
              href="/pricing"
              className="flex items-center gap-2 px-3 py-2 rounded-lg text-xs font-semibold text-brand-700 bg-brand-50 border border-brand-100 hover:bg-brand-100 transition-colors dark:bg-brand-950/40 dark:border-brand-900/50 dark:text-brand-400 dark:hover:bg-brand-950/60 mb-1"
            >
              <svg className="h-3.5 w-3.5" fill="currentColor" viewBox="0 0 20 20">
                <path d="M11.983 1.907a.75.75 0 0 0-1.292-.657l-8.5 9.5A.75.75 0 0 0 2.75 12h6.572l-1.305 6.093a.75.75 0 0 0 1.292.657l8.5-9.5A.75.75 0 0 0 17.25 8h-6.572l1.305-6.093Z" />
              </svg>
          ...
          <button
            ...
            className="flex w-full items-center gap-2 rounded-lg px-3 py-2 text-xs font-medium text-gray-500 hover:bg-gray-50 hover:text-gray-700 dark:text-gray-500 dark:hover:bg-gray-800/60 dark:hover:text-gray-300 transition-colors"
          >
  ...
  return (
    <>
      ...
      <div className="md:hidden fixed top-0 left-0 right-0 z-40 flex h-13 items-center justify-between border-b border-gray-100 dark:border-gray-800/80 bg-white/90 dark:bg-gray-950/90 backdrop-blur-md px-4 shadow-sm">
        <button
        ...
        <div className="flex items-center gap-2">
          <div className="flex h-6 w-6 items-center justify-center rounded-md bg-brand-500 shadow shadow-brand-900/30">
